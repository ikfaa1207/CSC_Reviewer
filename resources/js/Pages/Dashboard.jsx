...
export default function Dashboard({ categories, recentAttempts, analytics }) {
    ...
    return (
        ...
        >
            <Head>
                <title>Self-Assessment Dashboard | Zepo</title>
                <meta name="description" content="Track your Civil Service Exam preparation progress. View category performance analytics, exam readiness scores, and attempt history on Zepo." />
            </Head>
